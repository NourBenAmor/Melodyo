...
<head>
  ...
  <link rel="../Backend/stylesheet" href="css/custom_styles.css">

  <script src="../Backend/js/formvalidators/valider.js"></script>
</head>
     ...
     <div id="content" align="center">
        ...
        <div class="card shadow-lg m-4" >
          ...
          <div class="card-body" >
            ...
            <form action="../Backend/Ajoutinscription.php" method="POST" enctype="multipart/form-data" >
