      ...
      <div id="content">
        ...
        <div class="card shadow-lg m-4">
          <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-success">Modification d'un Compositeur</h6>
          </div>
          <div class="card-body">
            
            <form action="ModifComp.php" method="POST" onsubmit="return validate_formcat()">
                <div class="form-inline">
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control w-100 mt-2 mb-2" name="IdCom" id="IdCom" placeholder="Id Compositeur ">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="NomCom" id="NomCom" placeholder="Nom Du Compositeur">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="text" class="form-control w-100 mt-2 mb-2" name="Prenom" id="Prenom" placeholder="Prénom">
                  </div>
                  <div class="form-group col-md-6">
                    <input type="number" class="form-control w-100 mt-2 mb-2" name="Epoque" id="Epoque" placeholder="Epoque">
                  </div>
